...
//  COMPLETED (5) COMPLETED static constant integer values named CODE_WEATHER & CODE_WEATHER_WITH_DATE to identify the URIs this ContentProvider can handle
...
//      COMPLETED (9) Handle queries on both the weather and weather with date URI
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case CODE_WEATHER_WITH_DATE:
                ...
                cursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME, projection, where,
                        whereArgs, null, null, sortOrder);

                break;

            default:
                throw new UnsupportedOperationException("Invalid content URI");
        }

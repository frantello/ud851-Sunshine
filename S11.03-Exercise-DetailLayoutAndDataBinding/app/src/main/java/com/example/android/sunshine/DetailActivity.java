...
//      COMPLETED (8) Use mDetailBinding to display the date
        ...
        mDetailBinding.primaryWeatherInfo.icon.setImageResource(SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherId));

        /* Use the weatherId to obtain the proper description */
        String description = SunshineWeatherUtils.getStringForWeatherCondition(this, weatherId);

//      COMPLETED (15) Create the content description for the description for a11y
        mDetailBinding.primaryWeatherInfo.weatherDescription.setContentDescription(getString(R.string.a11y_forecast, description));
...
//      COMPLETED (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.primaryWeatherInfo.icon.setContentDescription(getString(R.string.a11y_forecast, description));
...
//      COMPLETED (17) Create the content description for the high temperature for a11y
        mDetailBinding.primaryWeatherInfo.highTemperature.setContentDescription(getString(R.string.a11y_high_temp, highString));
...
//      COMPLETED (18) Create the content description for the low temperature for a11y
        mDetailBinding.primaryWeatherInfo.lowTemperature.setContentDescription(getString(R.string.a11y_low_temp, lowString));
...
//      COMPLETED (20) Create the content description for the humidity for a11y
        mDetailBinding.extraWeatherDetails.humidity.setContentDescription(getString(R.string.a11y_humidity, humidityString));
...
//      COMPLETED (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.extraWeatherDetails.humidityLabel.setContentDescription(getString(R.string.a11y_humidity, humidityString));
...
//      COMPLETED (21) Create the content description for the wind for a11y
        mDetailBinding.extraWeatherDetails.wind.setContentDescription(getString(R.string.a11y_wind, windString));
...
//      COMPLETED (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.extraWeatherDetails.windLabel.setContentDescription(getString(R.string.a11y_wind, windString));
...
//      COMPLETED (23) Create the content description for the pressure for a11y
        mDetailBinding.extraWeatherDetails.pressure.setContentDescription(getString(R.string.a11y_pressure, pressureString));
...
//      COMPLETED (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.extraWeatherDetails.pressureLabel.setContentDescription(getString(R.string.a11y_pressure, pressureString));

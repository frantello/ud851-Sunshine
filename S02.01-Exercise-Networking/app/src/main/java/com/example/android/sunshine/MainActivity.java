...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        ...
        new QueryForecastTask().execute(SunshinePreferences.getPreferredWeatherLocation(this));
    }

    // COMPLETED (5) Create a class that extends AsyncTask to perform network requests
    private class QueryForecastTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... strings) {
            ...
            try {
                weathers = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, response);
